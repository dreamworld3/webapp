<template>
  <!--ref用来绑定div，在javascript里面通过调用：this.$refs.recommend.xxx来获取div的某个值-->
  <div class="recommend" ref="recommend" >
    <scroll class="recommend-content" ref="scroll" :data="playList"><!--v-bind:data的简写是:data-->
      <div>
       <!-- <div v-show="banner.length" class="decorate"></div>-->
        <div v-if="banner.length" class="slider-wrapper">
          <slider>
            <div v-for="item in banner" :key="item.id" @click.stop="selectBanner(item)"><!--on:click的简写是@click-->
              <img :src="item.picUrl">
            </div>
          </slider>
        </div>
